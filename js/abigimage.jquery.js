...
(function ($) {
    ...
    var last,
        ...
        layout      = $('<div>').addClass('abigimage-layout')     .appendTo(parent.$("body")),
        ...
        prevBtn     = $('<div>').addClass('abigimage-prevBtn')    .appendTo(bottomBox),
        nextBtn     = $('<div>').addClass('abigimage-nextBtn')    .appendTo(bottomBox),
        counter     = $('<div>').addClass('abigimage-counter')    .appendTo(bottomBox),
        filename    = $('<div>').addClass('abigimage-filename')   .appendTo(bottomBox),
