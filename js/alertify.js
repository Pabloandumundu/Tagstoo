...
/* This javascript differs from the original in http://alertifyjs.com/ (Licensed under GPLv3). Is very slightly modified to the use on the project Tagstoo */
	...
	Alertify = function () {
		...
		dialogs = {
			buttons : {
				...
				ok     : "<a class=\"large button green\" id=\"alertify-ok\">{{ok}}</a>",
				cancel : "<a class=\"large button red\" id=\"alertify-cancel\">{{cancel}}</a>"
			},
